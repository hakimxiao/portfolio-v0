...
const DEFAULT_INNER_GRADIENT =
  "linear-gradient(145deg,#263B66A6 0%,#5B8DEF33 100%)";
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      "--behind-glow-color": behindGlowColor ?? "rgba(91, 141, 239, 0.58)",
      ...
      "--sunpillar-1": "hsl(220, 88%, 68%)",
      "--sunpillar-2": "hsl(210, 84%, 70%)",
      "--sunpillar-3": "hsl(202, 92%, 70%)",
      "--sunpillar-4": "hsl(188, 88%, 72%)",
      "--sunpillar-5": "hsl(220, 88%, 68%)",
      "--sunpillar-6": "hsl(210, 84%, 70%)",
  ...
  const glareStyle: React.CSSProperties = {
    ...
    backgroundImage: `radial-gradient(
      farthest-corner circle at var(--pointer-x) var(--pointer-y),
      rgba(91, 141, 239, 0.38) 8%,
      rgba(113, 196, 255, 0.20) 42%,
      rgba(0, 0, 0, 0.35) 92%
    )`,
    mixBlendMode: "screen",
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            ...
            background:
              "linear-gradient(145deg, rgba(20, 20, 24, 0.98), rgba(8, 8, 8, 0.96))",
              ...
              {showUserInfo && (
                  ...
                  style={
                    {
                      ...
                      right: "var(--ui-inset)",
                      background:
                        "linear-gradient(135deg, rgba(17, 17, 17, 0.88), rgba(35, 35, 35, 0.7))",
                      borderRadius:
                ...
                >
                  <dl
                    ...
                    style={{
                      gridTemplateColumns:
                        "minmax(68px, 0.42fr) minmax(0, 1fr)",
                    }}
                  >
                    {profileDetails.map((item) => (
                      <React.Fragment key={item.label}>
                        ...
                        <dd className="truncate text-[11px] font-medium text-white/85">
                          {item.value}
                        </dd>
                      </React.Fragment>
                    ))}
              ...
              >
                <h3
                  ...
                  style={{
                    ...
                    backgroundImage:
                      "linear-gradient(to bottom, #fff, #5b8def)",
